package ags {
  ...
  public class ArcGISTileLayer extends TileLayerBase implements IEventDispatcher {
    ...
    public function ArcGISTileLayer(service:*, opt_layerOpts:ArcGISTileLayerOptions=undefined) {
      ...
      this.mapService_=(service is ArcGISMapService) ? service as ArcGISMapService : new ArcGISMapService(service as String);
      ...
      if (this.mapService_.hasLoaded()) {
        ...
        this.mapService_.addEventListener(ArcGISEvent.LOAD, function():void {
      ...
      if (this.mapService_.hasLoaded()) {
        dispatchEvent(new ArcGISEvent(ArcGISEvent.LOAD));
      }
    }
