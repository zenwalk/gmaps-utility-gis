...
*/
var f = Math.PI / 180, aa = 0, h = google.maps, j, l, n, r = {H:null, D:false}, s = {}, u = {};
function v(a, b, c) {
...
function P(a) {
  a = a || {};
  N.call(this, a);
  var b = a.s, c = a.w * f, d = a.z * f, e = a.t * f;
  this.a = a.m / a.n;
  this.g = a.l * f;
  this.i = a.q;
  this.j = a.r;
  ...
  this.u = this.k(this.a, this.B, e, this.b)
}
P.prototype = new N;
...
P.prototype.forward = function(a) {
  var b = a[0] * f;
  a = this.k(this.a, this.B, R(this, a[1] * f, this.c), this.b);
  b = this.b * (b - this.g);
  return[this.i + a * Math.sin(b), this.j + this.u - a * Math.cos(b)]
};
...
function S(a) {
  ...
  a = 1 / b;
  this.e = 2 * a - a * a;
  this.p = this.e * this.e;
  this.F = this.p * this.e;
  this.o = this.e / (1 - this.e);
  this.K = this.d(c, this.a, this.e, this.p, this.F)
}
S.prototype = new N;
...
S.prototype.forward = function(a) {
  ...
  var d = Math.pow(Math.tan(b), 2), e = this.o * Math.pow(Math.cos(b), 2);
  c = (c - this.g) * Math.cos(b);
  var g = this.d(b, this.a, this.e, this.p, this.F);
  return[this.i + this.G * a * (c + (1 - d + e) * Math.pow(c, 3) / 6 + (5 - 18 * d + d * d + 72 * e - 58 * this.o) * Math.pow(c, 5) / 120), this.j + this.G * (g - this.K) + a * Math.tan(b) * (c * c / 2 + (5 - d + 9 * e + 4 * e * e) * Math.pow(c, 4) / 120 + (61 - 58 * d + d * d + 600 * e - 330 * this.o) * Math.pow(c, 6) / 720)]
};
...
function U(a) {
  ...
  this.b = (a * a - b * b) / (d - c);
  this.A = a * a + this.b * c;
  this.u = this.k(this.a, this.A, this.b, e)
}
U.prototype = new N;
...
U.prototype.forward = function(a) {
  var b = a[0] * f;
  a = this.k(this.a, this.A, this.b, V(this, a[1] * f, this.c));
  b = this.b * (b - this.g);
  return[this.i + a * Math.sin(b), this.j + this.u - a * Math.cos(b)]
};
...
j = new O({wkid:4326});
l = new O({wkid:4269});
n = new T({wkid:102113, semi_major:6378137, central_meridian:0, unit:1});
s = {"4326":j, "4269":l, "102113":n, "102100":new T({wkid:102100, semi_major:6378137, central_meridian:0, unit:1})};
u.S = function(a, b) {
  var c = s["" + a];
  if(c) {
    return c
  ...
  if(b instanceof N) {
    ...
    if(e !== "") {
      d.n = parseFloat(v(v(c, "PROJECTION", ""), "UNIT[", "]").split(",")[1]);
      d.m = parseFloat(g[1]);
      d.s = parseFloat(g[2]);
      d.t = parseFloat(v(c, '"Latitude_Of_Origin",', "]"));
      d.l = parseFloat(v(c, '"Central_Meridian",', "]"));
      d.q = parseFloat(v(c, '"False_Easting",', "]"));
      d.r = parseFloat(v(c, '"False_Northing",', "]"))
    }
    switch(e) {
      case "":
        c = new N(d);
      ...
      case "Lambert_Conformal_Conic":
        d.w = parseFloat(v(c, '"Standard_Parallel_1",', "]"));
        d.z = parseFloat(v(c, '"Standard_Parallel_2",', "]"));
        c = new P(d);
        break;
      case "Transverse_Mercator":
        d.O = parseFloat(v(c, '"Scale_Factor",', "]"));
        c = new S(d);
        break;
      case "Albers":
        d.w = parseFloat(v(c, '"Standard_Parallel_1",', "]"));
            ...
            a: {
              ...
              if(k) {
                ...
                if(k.x) {
                  ...
                  if(k.rings) {
                    m = new h.Polygon(y(p.R || p, {paths:fa}));
                    t.push(m)
                  }
                }
              }
...
function W(a) {
  ...
  this.v = a ? s[a.spatialReference.wkid || a.spatialReference.wkt] : n;
  if(!this.v) {
    throw new Error("unsupported Spatial Reference");
  }
  this.I = a ? a.lods[0].resolution : 156543.033928;
  this.minZoom = Math.floor(Math.log(this.v.h() / this.I / 256) / Math.LN2 + 0.5);
...
W.prototype.fromLatLngToPoint = function(a, b) {
  ...
  var c = this.v.forward([a.lng(), a.lat()]), d = b || new h.Point(0, 0);
